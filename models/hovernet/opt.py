        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        "pretrained": "/2TB_mount/Lymphoma_data/From_analyses/Feb_2022_DL_stain_separated_Annotations/HoverNet_data/Hover_net_checkpoints/pannuke_seg_monusac_type_chimera_weightset.tar",
                        # 'pretrained': None,
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 5, "valid": 5},  # engine name : value
                "nr_epochs": 50,
            }
            # {
            #     "run_info": {
