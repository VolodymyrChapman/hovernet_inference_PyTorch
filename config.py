...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = '/2TB_mount/Lymphoma_data/From_analyses/Feb_2022_DL_stain_separated_Annotations/HoverNet_data/Output_models/In_progress'  # where checkpoints will be saved

        # paths to training and validation patches
        # self.train_dir_list = os.listdir('/media/veracrypt1/Lymphoma_subgrouping/Projects/Feb_2022_DL_on_nuclei_images/Hover_net/Patches_test')
        # self.valid_dir_list = os.listdir('/media/veracrypt1/Lymphoma_subgrouping/Projects/Feb_2022_DL_on_nuclei_images/Hover_net/Patches_test')

        self.train_dir_list = ['/2TB_mount/Lymphoma_data/From_analyses/Feb_2022_DL_stain_separated_Annotations/QuPath_annotations/24_02_2022_QuPath_patches']
        self.valid_dir_list = ['/2TB_mount/Lymphoma_data/From_analyses/Feb_2022_DL_stain_separated_Annotations/QuPath_annotations/24_02_2022_QuPath_patches']
